...
class Torro_Forms_Wheel_Of_Fortune_Pluginsearcher extends Torro_Form_Action {
	/**
	 * Instance
	 *
	 * @var null|Torro_Forms_Wheel_Of_Fortune_Pluginsearcher
	 * @since 1.0.0
	 */
	 ...
	 * Singleton
	 *
	 * @return Torro_Forms_Wheel_Of_Fortune_Pluginsearcher
	 * @since 1.0.0
	 */
	...
	protected function init() {
		$this->title = __( 'WP.org Plugin Search Redirection', 'torro-forms-wheel-of-fortune' );
	...
	public function option_content( $form_id ) {
		...
		$html .= '<tr>';
		$html .= '<td>';
		$html .= '<label for="field_to_search_plugin">' . esc_attr__( 'Field to search for', 'torro-forms-wheel-of-fortune' ) . '</label>';
		$html .= '</td>';
		$html .= '<td>';
		$html .= '<input type="text" name="field_to_search_plugin" value="' . $field_to_search . '" />';
		$html .= '<small>' . __( 'Redirect the user to wp.org to search for a plugin named after the field content.', 'torro-forms-wheel-of-fortune' ) . '</small>';
		$html .= '</td>';
		$html .= '</tr>';
...
torro()->actions()->register( 'Torro_Forms_Wheel_Of_Fortune_Pluginsearcher' );
